...
import { mockRecruiters } from "@/lib/data/mock-data";
  ...
  return (
    <Card className="shadow-sm border-none overflow-hidden">
      <CardHeader className="bg-white border-b border-gray-100 pb-4">
        <CardTitle className="text-lg font-bold">Danh sách nhà tuyển dụng</CardTitle>
      </CardHeader>
            ...
            <TableBody>
              {mockRecruiters.map((recruiter) => (
                ...
                >
                  ...
                  <TableCell className="text-gray-500">{recruiter.date}</TableCell>
