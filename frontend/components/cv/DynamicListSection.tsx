    ...
    <SectionWrapper title={title}>
      <div className="flex flex-col gap-1.5">
        {items.map((item, index) => (
          <div
            key={item.id}
            className="relative group/item flex items-start gap-2 border border-transparent hover:border-dashed hover:border-blue-200 hover:bg-blue-50/20 px-2 py-1.5 rounded-md transition-all duration-150"
          >
            {/* Content */}
