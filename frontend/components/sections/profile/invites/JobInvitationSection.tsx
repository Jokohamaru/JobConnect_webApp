...
const TABS: { key: TabKey; label: string; emptyText: string }[] = [
  { key: "pending", label: "Đang chờ", emptyText: "Bạn có 0 Lời mời đang chờ" },
  {
    key: "accepted",
    label: "Đã chấp nhận",
    emptyText: "Bạn có 0 Lời mời đã chấp nhận",
  },
  {
    key: "expired",
    label: "Đã hết hạn",
    emptyText: "Bạn có 0 Lời mời đã hết hạn",
  },
];
  ...
  return (
    <div className="px-4 flex flex-col gap-3">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm">
        <h2 className="text-xl font-semibold mb-1">Lời mời công việc</h2>
        <p className="text-sm text-gray-500 mb-5">
          ITviec cung cấp dịch vụ kết nối ứng viên ẩn danh với các cơ hội việc
          làm phù hợp. Tìm hiểu thêm về Lời mời công việc{" "}
      ...
      <div className="flex items-center gap-2 text-sm text-gray-500">
        ...
        <p>
          Mục này lưu trữ lời mời còn hiệu lực, bạn có thể xem chi tiết và chia
          sẻ CV.
        </p>
      </div>
