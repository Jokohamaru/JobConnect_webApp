...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast('Đăng ký thành công! Chào mừng bạn đến với JobConnect.', 'success');
      router.push('/');
    } catch (err) {
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-blue-500 to-cyan-400 p-12 xl:p-16 items-center">
        <div className="max-w-xl text-white">
          <h2 className="text-3xl font-bold mb-8">
            Đăng ký để truy cập vào thông tin chi tiết về thị trường việc làm được cá nhân hóa!
          </h2>
